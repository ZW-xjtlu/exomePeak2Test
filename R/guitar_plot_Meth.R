#'@title Produce code for guitar plot after refined methylation call.
#'@import magrittr
#'@import exomePeak2
#'@export
guitar_plot_Meth <- function(pkc_rds_file,
                        front_name,
                        ...){
  ...
  code_all <- c(code_library, code_GC_norm, code_Meth_glm, code_plot)
